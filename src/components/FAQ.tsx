...
const faqs = [
  {
    ...
    a: "Вы можете выбрать готовый подарок в каталоге, воспользоваться экспресс-подбором или конструктором подарка. При нажатии на кнопку «Заказать» или «Оформить заказ» сформируется готовая заявка с вашими параметрами для персонального консьержа, который сразу примет заказ в работу."
  },
  {
    q: "Как происходит оплата заказа?",
    a: "Оплата происходит после полного согласования всех деталей с вашим консьержем. Сначала флористы и кондитеры собирают заказ, вам присылают фото/видео готового подарка и открытки, и только после вашего одобрения высылаются реквизиты для оплаты любым российским банком (СБП, перевод, картой)."
  },
  {
  ...
  },
  {
    ...
    a: "Конечно. Вы можете указать удобный 30-минутный интервал при согласовании с консьержем."
  },
  {
  ...
  },
  {
    ...
    a: "Да! Вы можете попросить заменить сорт цветов, добавить сладости или свечи, изменить размер букета под ваш персональный бюджет."
  }
];
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-12 p-6 rounded-3xl bg-bg-cream border border-gray-100 text-center space-y-3">
          ...
          <p className="text-xs text-text-dark/60 max-w-md mx-auto">
            Наш консьерж ответит вам в течение 2-3 минут и поможет с выбором.
          </p>
          <button
